 ...
 */
export declare class TDSSingletonService {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<TDSSingletonService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<TDSSingletonService>;
}
