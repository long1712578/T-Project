...
import { TDSDateConfig } from './date-config';
import { TDSI18nService } from './tds-i18n.service';
import * as i0 from "@angular/core";
export declare function DATE_HELPER_SERVICE_FACTORY(injector: Injector, config: TDSDateConfig): DateHelperService;
/**
...
export declare abstract class DateHelperService {
    ...
    protected config: TDSDateConfig;
    constructor(i18n: TDSI18nService, config: TDSDateConfig);
