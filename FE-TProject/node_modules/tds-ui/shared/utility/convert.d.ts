...
export declare function toCssPixel(value: number | string | null): string;
/**
 * Get the function-property type's value
 */
export declare function valueFunctionProp<T>(prop: FunctionProp<T> | T, ...args: any[]): T;
/**
...
export declare function InputNumber(fallbackValue?: any): any;
