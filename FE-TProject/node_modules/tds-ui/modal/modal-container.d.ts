...
export declare class BaseModalContainerComponent extends BasePortalOutlet implements OnDestroy {
    ...
    constructor(elementRef: ElementRef, focusTrapFactory: FocusTrapFactory, cdr: ChangeDetectorRef, render: Renderer2, overlayRef: OverlayRef, tdsConfigService: TDSConfigService, config: ModalOptions, document?: any, animationType?: string | undefined);
