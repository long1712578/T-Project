...
const menuCollapseMotion = trigger('menuCollapseMotion', [
    state('expanded', style({ height: '*' })),
    state('collapsed', style({ height: 0, overflow: 'hidden' })),
    state('hidden', style({ height: 0, overflow: 'hidden', borderTopWidth: '0' })),
...
export { AnimationCurves, AnimationDuration, cancelRequestAnimationFrame, collapseMotion, fadeMotion, helpMotion, menuCollapseMotion, moveUpMotion, notificationMotion, reqAnimFrame, slideAlertMotion, slideMotion, treeCollapseMotion, zoomBadgeMotion, zoomBigMotion };
//# sourceMappingURL=tds-ui-core-animation.mjs.map
