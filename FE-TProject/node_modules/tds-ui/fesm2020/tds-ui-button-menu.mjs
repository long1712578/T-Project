...
TDSButtonMenuItem.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSButtonMenuItem, selectors: [["", "tds-button-menu-item", ""]], hostAttrs: [1, "flex", "flex-col", "justify-center", "w-full", "text-body-2", "font-regular", "hover:bg-neutral-3-50", "focus:outline-none", "px-3", "dark:hover:bg-d-neutral-3-300"], hostVars: 18, hostBindings: function TDSButtonMenuItem_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { disabled: "disabled", disableRipple: "disableRipple", size: "size", role: "role" }, exportAs: ["TDSButtonMenuItem"], features: [i0.ɵɵInheritDefinitionFeature, i0.ɵɵNgOnChangesFeature], attrs: _c0$1, ngContentSelectors: _c1, decls: 1, vars: 0, template: function TDSButtonMenuItem_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵprojectionDef();
        i0.ɵɵprojection(0);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSButtonMenuTrigger, [{
        ...
        args: [{
    ...
    }], function () { return [{ type: i1$2.Overlay }, { type: i0.ElementRef }, { type: i0.ViewContainerRef }, { type: undefined, decorators: [{
                type: Inject,
                ...
                type: Optional
            }] }, { type: i1.FocusMonitor }]; }, { _deprecatedMatMenuTriggerFor: [{
            type: Input,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(_TDSButtonMenuDirectivesModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(_TDSButtonMenuDirectivesModule, { declarations: [TDSButtonMenuTrigger,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSButtonMenuModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSButtonMenuModule, { declarations: [TDSButtonMenu, TDSButtonMenuItem], imports: [CommonModule,
