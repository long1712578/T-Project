...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSRadioButtonDirective, [{
        type: Directive,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSRadioService, [{
        type: Injectable
    }], null, null); })();
...
TDSRadioGroupComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSRadioGroupComponent, selectors: [["tds-radio-group"]], hostVars: 8, hostBindings: function TDSRadioGroupComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ...
        ]), i0.ɵɵNgOnChangesFeature], ngContentSelectors: _c0$1, decls: 1, vars: 0, template: function TDSRadioGroupComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵprojectionDef();
        i0.ɵɵprojection(0);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSRadioGroupComponent, [{
    ...
    }], function () { return [{ type: i0.ChangeDetectorRef }, { type: TDSRadioService }, { type: i0.ElementRef }, { type: i2.Directionality, decorators: [{
                type: Optional
            }] }]; }, { disabled: [{
            type: Input
        }], buttonStyle: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSRadioModule, [{
        type: NgModule,
        args: [{
