...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSDateCellDirective, [{
        type: Directive,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMonthCellDirective, [{
        type: Directive,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSDateFullCellDirective, [{
        type: Directive,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMonthFullCellDirective, [{
        type: Directive,
        args: [{
...
TDSCalendarEventComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSCalendarEventComponent, selectors: [["tds-calendar-event"]], inputs: { tdsStartDate: "tdsStartDate", tdsEndDate: "tdsEndDate", tdsData: "tdsData", tdsTemplate: "tdsTemplate" }, features: [i0.ɵɵNgOnChangesFeature], ngContentSelectors: _c0$3, decls: 1, vars: 0, template: function TDSCalendarEventComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵprojectionDef();
        i0.ɵɵprojection(0);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSCalendarComponent, [{
  ...
  `,
    ...
    }], function () { return [{ type: i0.ChangeDetectorRef }, { type: i1$2.Directionality, decorators: [{
                type: Optional
            }] }]; }, { tdsMode: [{
            type: Input
        }], tdsValue: [{
...
TDSCalendarModeWeekComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSCalendarModeWeekComponent, selectors: [["tds-calendar-mode-week"]], decls: 2, vars: 0, template: function TDSCalendarModeWeekComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵelementStart(0, "p");
        i0.ɵɵtext(1, "tds-calendar-mode-week works!");
        i0.ɵɵelementEnd();
    } }, encapsulation: 2, changeDetection: 0 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSCalendarModeWeekComponent, [{
        type: Component,
...
TDSCalendarModeMonthComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSCalendarModeMonthComponent, selectors: [["tds-calendar-mode-month"]], decls: 2, vars: 0, template: function TDSCalendarModeMonthComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵelementStart(0, "p");
        i0.ɵɵtext(1, "tds-calendar-mode-month works!");
        i0.ɵɵelementEnd();
    } }, encapsulation: 2, changeDetection: 0 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSCalendarModeMonthComponent, [{
        type: Component,
...
TDSCalendarModeYearComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSCalendarModeYearComponent, selectors: [["tds-calendar-mode-year"]], decls: 2, vars: 0, template: function TDSCalendarModeYearComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵelementStart(0, "p");
        i0.ɵɵtext(1, "tds-calendar-mode-year works!");
        i0.ɵɵelementEnd();
    } }, encapsulation: 2, changeDetection: 0 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSCalendarModeYearComponent, [{
        type: Component,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSCalendarModule, [{
        type: NgModule,
        args: [{
                declarations: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSCalendarModule, { declarations: [TDSCalendarHeaderComponent,
        TDSCalendarComponent,
        TDSDateCellDirective,
        TDSDateFullCellDirective,
        TDSMonthCellDirective,
