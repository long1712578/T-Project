...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMenuService, [{
        type: Injectable
    }], null, null); })();
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMenuItemComponent, [{
    ...
    }], function () { return [{ type: i0.ChangeDetectorRef }, { type: TDSMenuService }, { type: i2.RouterLink, decorators: [{
                type: Optional
...
const _c0 = ["logo-text"];
function TDSMenuComponent_div_1_div_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 8);
    i0.ɵɵprojection(1);
    i0.ɵɵelementEnd();
} }
function TDSMenuComponent_div_1_div_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 8);
    i0.ɵɵprojection(1, 1);
    i0.ɵɵelementEnd();
} }
function TDSMenuComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 5);
...
function TDSMenuComponent_ng_container_3_ng_template_1_tds_menu_group_popup_0_ng_template_1_Template(rf, ctx) { if (rf & 1) {
...
function TDSMenuComponent_ng_container_3_ng_template_1_tds_menu_group_popup_0_Template(rf, ctx) { if (rf & 1) {
...
function TDSMenuComponent_ng_container_3_ng_template_1_Template(rf, ctx) { if (rf & 1) {
...
function TDSMenuComponent_ng_container_3_Template(rf, ctx) { if (rf & 1) {
...
function TDSMenuComponent_ng_container_4_ng_template_1_tds_menu_group_inline_0_ng_template_1_Template(rf, ctx) { if (rf & 1) {
...
function TDSMenuComponent_ng_container_4_ng_template_1_tds_menu_group_inline_0_Template(rf, ctx) { if (rf & 1) {
...
function TDSMenuComponent_ng_container_4_ng_template_1_Template(rf, ctx) { if (rf & 1) {
...
function TDSMenuComponent_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementContainerStart(0);
...
function TDSMenuComponent_div_5_Template(rf, ctx) { if (rf & 1) {
...
TDSMenuComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSMenuComponent, selectors: [["tds-menu"]], contentQueries: function TDSMenuComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        i0.ɵɵcontentQuery(dirIndex, _c0, 5);
    } if (rf & 2) {
        let _t;
        i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx.logoText = _t.first);
    } }, viewQuery: function TDSMenuComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, hostAttrs: [1, "h-full", "flex", "flex-col", "box-border"], hostVars: 4, hostBindings: function TDSMenuComponent_HostBindings(rf, ctx) { if (rf & 2) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMenuComponent, [{
        type: Component,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMenuModule, [{
        type: NgModule,
        args: [{
                imports: [
                    BidiModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSMenuModule, { declarations: [TDSMenuComponent,
        TDSMenuItemComponent,
        TDSMenuGroupInlineComponent,
