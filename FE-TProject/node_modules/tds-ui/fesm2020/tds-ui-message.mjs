...
function TDSMessageComponent_i_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 10);
} }
function TDSMessageComponent_i_5_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 11);
} }
function TDSMessageComponent_i_6_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 12);
} }
function TDSMessageComponent_i_7_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 13);
} }
function TDSMessageComponent_tds_spinner_8_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "tds-spinner", 14);
} if (rf & 2) {
    i0.ɵɵproperty("color", "primary");
} }
function TDSMessageComponent_ng_container_9_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMessageComponent, [{
        type: Component,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMessageServiceModule, [{
        type: NgModule
    }], null, null); })();
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSMessageModule, [{
        type: NgModule,
        args: [{
