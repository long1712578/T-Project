...
TDSError.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSError, selectors: [["tds-error"]], hostAttrs: ["aria-atomic", "true", 1, "tds-error", "text-xs", "leading-4", "font-normal", "text-error-500", "dark:text-d-error-500", "mt-1", "inline-flex", "items-center"], hostVars: 1, hostBindings: function TDSError_HostBindings(rf, ctx) { if (rf & 2) {
    ...
    } }, inputs: { id: "id", icon: "icon" }, features: [i0.ɵɵProvidersFeature([{ provide: TDS_ERROR, useExisting: TDSError }])], ngContentSelectors: _c0$4, decls: 2, vars: 1, consts: [[1, "mr-2", 3, "ngClass"]], template: function TDSError_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵprojectionDef();
        i0.ɵɵelement(0, "i", 0);
        i0.ɵɵprojection(1);
    } if (rf & 2) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSFormFieldControl, [{
        type: Directive
    }], null, null); })();
...
TDSFormFieldContainer.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: TDSFormFieldContainer, selectors: [["", "tds-form-field-container", ""]], hostVars: 2, hostBindings: function TDSFormFieldContainer_HostBindings(rf, ctx) { if (rf & 2) {
        i0.ɵɵclassMap(ctx.tdsClass);
    } }, inputs: { tdsClass: "tdsClass" } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSFormFieldContainer, [{
        type: Directive,
        args: [{
...
TDSSuccess.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSSuccess, selectors: [["tds-success"]], hostAttrs: ["aria-atomic", "true", 1, "tds-success", "text-success-400", "text-xs", "leading-4", "font-normal", "mt-1", "inline-flex", "items-center"], hostVars: 1, hostBindings: function TDSSuccess_HostBindings(rf, ctx) { if (rf & 2) {
        i0.ɵɵattribute("id", ctx.id);
    } }, inputs: { id: "id", icon: "icon" }, features: [i0.ɵɵProvidersFeature([{ provide: TA_SUCCESS, useExisting: TDSSuccess }])], ngContentSelectors: _c0$1, decls: 2, vars: 1, consts: [[1, "mr-2", 3, "ngClass"]], template: function TDSSuccess_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵprojectionDef();
        i0.ɵɵelement(0, "i", 0);
        i0.ɵɵprojection(1);
    } if (rf & 2) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSFormFieldModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSFormFieldModule, { declarations: [TDSFormField,
        TDSLabel,
        TDSSuccess,
        TDSError,
        TDSWarning,
