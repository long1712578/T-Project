...
TDSBreakpointService.ɵfac = function TDSBreakpointService_Factory(t) { return new (t || TDSBreakpointService)(i0.ɵɵinject(TDSResizeService), i0.ɵɵinject(i2.MediaMatcher)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSBreakpointService, [{
    ...
    }], function () { return [{ type: TDSResizeService }, { type: i2.MediaMatcher }]; }, null); })();

class TDSDestroyService extends Subject {
    ngOnDestroy() {
        this.next();
        this.complete();
    }
}
TDSDestroyService.ɵfac = /*@__PURE__*/ function () { let ɵTDSDestroyService_BaseFactory; return function TDSDestroyService_Factory(t) { return (ɵTDSDestroyService_BaseFactory || (ɵTDSDestroyService_BaseFactory = i0.ɵɵgetInheritedFactory(TDSDestroyService)))(t || TDSDestroyService); }; }();
TDSDestroyService.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: TDSDestroyService, factory: TDSDestroyService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSDestroyService, [{
        type: Injectable
    }], null, null); })();
...
export { TDSBreakpointEnum, TDSBreakpointService, TDSDestroyService, TDSDragService, TDSResizeService, TDSScrollService, TDSSingletonService, environment, gridResponsiveMap, siderResponsiveMap };
//# sourceMappingURL=tds-ui-core-services.mjs.map
