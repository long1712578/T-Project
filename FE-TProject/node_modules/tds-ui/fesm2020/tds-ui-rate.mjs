...
function TDSRateItemComponent_ng_template_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 4);
} }
...
TDSRateItemComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSRateItemComponent, selectors: [["", "tds-rate-item", ""]], inputs: { isHalf: "isHalf", character: "character", index: "index", allowHalf: "allowHalf" }, outputs: { itemHover: "itemHover", itemClick: "itemClick" }, exportAs: ["tdsRateItem"], attrs: _c0$1, decls: 6, vars: 12, consts: [[1, "tds-rate-star-second", "select-none", "text-current", 3, "mouseover", "click"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "tds-rate-star-first", "select-none", "absolute", "left-0", "top-0", "w-1/2", "h-full", "overflow-hidden", 3, "ngClass", "mouseover", "click"], ["defaultCharacter", ""], [1, "tdsi-star-1-fill"]], template: function TDSRateItemComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSRateItemComponent, [{
        type: Component,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSRateComponent, [{
  ...
  `,
    ...
    }], function () { return [{ type: i1$1.TDSConfigService }, { type: i0.Renderer2 }, { type: i0.ChangeDetectorRef }, { type: i2.Directionality, decorators: [{
                type: Optional
            }] }]; }, { ulElement: [{
            type: ViewChild,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSRateModule, [{
        type: NgModule,
        args: [{
