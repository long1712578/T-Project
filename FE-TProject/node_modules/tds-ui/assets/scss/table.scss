@layer utilities {
    tds-table {
        ...
        .tds-table-thead > tr > th {
            @apply bg-neutral-3-50  dark:bg-d-neutral-3-300 p-3 dark:text-d-neutral-1-900;
        }
        .tds-table-tbody > tr:not(.tds-table-placeholder) > td {
            transition: background 0.1s;
            @apply border-b border-neutral-2-100 text-neutral-1-900 dark:text-d-neutral-1-900 ;
        }
        ...
        .tds-table-tbody > tr.tds-table-row:not(.tds-row-selected):hover > td {
            @apply bg-neutral-3-50 dark:bg-d-neutral-3-300;
        }
        .tds-table-cell-fix-left {
            @apply bg-white dark:bg-d-neutral-3-200 ;
        }
        ...
        .tds-table-tbody > tr.tds-row-selected > td {
            @apply bg-info-100 dark:bg-d-info-100;
        }
    }
  }