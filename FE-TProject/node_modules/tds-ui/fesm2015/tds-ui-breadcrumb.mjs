...
function TDSBreadCrumbItemComponent_ng_container_0_span_3_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelement(0, "span", 6);
    }
}
function TDSBreadCrumbItemComponent_ng_container_0_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSBreadCrumbItemComponent_ng_template_1_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSBreadCrumbItemComponent_span_3_ng_container_1_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
...
function TDSBreadCrumbItemComponent_span_3_Template(rf, ctx) {
    if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSBreadCrumbItemComponent, [{
            type: Component,
            args: [{
...
function TDSBreadCrumbComponent_ng_container_1_tds_breadcrumb_item_1_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSBreadCrumbComponent_ng_container_1_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
...
TDSBreadCrumbComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSBreadCrumbComponent, selectors: [["tds-breadcrumb"]], contentQueries: function TDSBreadCrumbComponent_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
    ...
    }, viewQuery: function TDSBreadCrumbComponent_Query(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSBreadCrumbComponent, [{
            type: Component,
            args: [{
                    changeDetection: ChangeDetectionStrategy.OnPush,
                    encapsulation: ViewEncapsulation.None,
    ...
    <ng-container *ngIf="autoGenerate && breadcrumbs.length">
      <tds-breadcrumb-item *ngFor="let breadcrumb of breadcrumbs;let last = last" [active]="last" [separator]='last ? null : separator'>
        ...
        return [{ type: i0.Injector }, { type: i0.NgZone }, { type: i0.ChangeDetectorRef }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i1$1.Directionality, decorators: [{
                        type: Optional
                    }] }];
    }, { defaultSeparator: [{
                type: ViewChild,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSBreadCrumbSeparatorComponent, [{
            type: Component,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSBreadCrumbModule, [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSBreadCrumbModule, { declarations: [TDSBreadCrumbComponent,
            TDSBreadCrumbItemComponent,
