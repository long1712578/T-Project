...
function TDSPopoverComponent_ng_template_0_div_6_ng_container_1_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSPopoverComponent_ng_template_0_div_6_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSPopoverComponent_ng_template_0_ng_container_9_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
        i0.ɵɵtext(1);
        i0.ɵɵelementContainerEnd();
...
function TDSPopoverComponent_ng_template_0_div_10_ng_container_1_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
        i0.ɵɵtext(1);
        i0.ɵɵelementContainerEnd();
...
function TDSPopoverComponent_ng_template_0_div_10_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSPopoverComponent_ng_template_0_Template(rf, ctx) {
    if (rf & 1) {
...
class TDSPopoverDirective extends TDSTooltipBaseDirective {
    ...
    getProxyPropertyMap() {
        return Object.assign({ popoverBackdrop: ['backdrop', () => this.popoverBackdrop], autoClose: ['autoClose', () => this.autoClose] }, super.getProxyPropertyMap());
    }
}
...
TDSPopoverDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: TDSPopoverDirective, selectors: [["", "tds-popover", ""]], hostVars: 2, hostBindings: function TDSPopoverDirective_HostBindings(rf, ctx) {
        if (rf & 2) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSPopoverDirective, [{
            type: Directive,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSPopoverComponent, [{
            type: Component,
            args: [{
                    selector: 'tds-popover',
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSPopoverModule, [{
            type: NgModule,
            args: [{
