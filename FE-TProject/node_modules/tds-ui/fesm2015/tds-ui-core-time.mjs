...
class NgTimeParser {
    ...
    toDate(str) {
        ...
        const time = new Date();
        if (TDSHelperObject.hasValue(result === null || result === void 0 ? void 0 : result.hour)) {
            time.setHours(result.hour);
        }
        if (TDSHelperObject.hasValue(result === null || result === void 0 ? void 0 : result.minute)) {
            time.setMinutes(result.minute);
        }
        if (TDSHelperObject.hasValue(result === null || result === void 0 ? void 0 : result.second)) {
...
//# sourceMappingURL=tds-ui-core-time.mjs.map
