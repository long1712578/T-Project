...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSTreeBaseService, [{
            type: Injectable
        }], null, null);
})();

const TDSTreeHigherOrderServiceToken = new InjectionToken('TDSTreeHigherOrder');
...
export { TDSTreeBase, TDSTreeBaseService, TDSTreeHigherOrderServiceToken, TDSTreeNode, flattenTreeData, getKey, getPosition, isCheckDisabled, isInArray };
//# sourceMappingURL=tds-ui-core-tree.mjs.map
