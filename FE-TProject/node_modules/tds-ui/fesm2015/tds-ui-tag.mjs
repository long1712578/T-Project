...
function TDSTagComponent_ng_container_1_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSTagComponent_ng_container_2_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSTagComponent_ng_container_3_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
...
function TDSTagComponent_ng_template_4_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵprojection(0);
    }
}
...
TDSTagComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSTagComponent, selectors: [["tds-tag"]], hostAttrs: [1, "group", "inline-flex", "box-content"], hostBindings: function TDSTagComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
