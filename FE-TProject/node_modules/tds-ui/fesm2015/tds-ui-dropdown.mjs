...
TDSDropdownMenuComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSDropdownMenuComponent, selectors: [["tds-dropdown-menu"]], viewQuery: function TDSDropdownMenuComponent_Query(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
            ...
            //   useValue: true
            // }
        ])], ngContentSelectors: _c0, decls: 1, vars: 0, consts: [[1, "tds-dropdown", "min-w-full", "relative", 3, "ngClass", "ngStyle", "mouseenter", "mouseleave"], [1, "py-1", "w-full"], [1, "w-full", "bg-white", "dark:bg-d-neutral-3-300", "shadow-1-lg", "rounded", "py-1"]], template: function TDSDropdownMenuComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵprojectionDef();
...
(function () {
  ...
  `,
        ...
        return [{ type: i0.ChangeDetectorRef }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i0.ViewContainerRef }, { type: i1$1.TDSMenuService }, { type: i2$1.Directionality, decorators: [{
                        type: Optional
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSDropDownModule, { declarations: [TDSDropDownDirective,
            TDSDropDownADirective,
            TDSDropdownMenuComponent,
            TDSDropdownButtonDirective,
