...
import { InjectionToken, forwardRef, EventEmitter, Component, ViewEncapsulation, ChangeDetectionStrategy, Attribute, Optional, Inject, Input, Output, ViewChild, NgModule } from '@angular/core';
...
const TDS_CHECKBOX_DEFAULT_OPTIONS = new InjectionToken('tds-checkbox-default-options', {
    providedIn: 'root',
    factory: TDS_CHECKBOX_DEFAULT_OPTIONS_FACTORY
});
/** @docs-private */
function TDS_CHECKBOX_DEFAULT_OPTIONS_FACTORY() {
    return {
...
function TDSCheckbox__svg_svg_6_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵnamespaceSVG();
...
function TDSCheckbox__svg_svg_7_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵnamespaceSVG();
 ...
 * @docs-private
 */
const TDS_CHECKBOX_CONTROL_VALUE_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => TDSCheckbox),
    multi: true
};
/** Change event object emitted by MatCheckbox. */
class TDSCheckboxChange {
}
 ...
 */
class TDSCheckbox extends _TACheckboxMixinBase {
...
TDSCheckbox.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSCheckbox, selectors: [["tds-checkbox"]], viewQuery: function TDSCheckbox_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, hostAttrs: [1, "tds-checkbox"], hostVars: 8, hostBindings: function TDSCheckbox_HostBindings(rf, ctx) {
        if (rf & 2) {
...
class TDSCheckBoxModule {
}
TDSCheckBoxModule.ɵfac = function TDSCheckBoxModule_Factory(t) { return new (t || TDSCheckBoxModule)(); };
TDSCheckBoxModule.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: TDSCheckBoxModule });
TDSCheckBoxModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ imports: [[
            ReactiveFormsModule,
            FormsModule,
            CommonModule
        ]] });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSCheckBoxModule, [{
            type: NgModule,
            args: [{
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSCheckBoxModule, { declarations: [TDSCheckbox], imports: [ReactiveFormsModule,
            FormsModule,
            CommonModule], exports: [TDSCheckbox] });
})();
...
export { TDSCheckBoxModule, TDSCheckbox, TDSCheckboxChange, TDS_CHECKBOX_CONTROL_VALUE_ACCESSOR };
//# sourceMappingURL=tds-ui-tds-checkbox.mjs.map
