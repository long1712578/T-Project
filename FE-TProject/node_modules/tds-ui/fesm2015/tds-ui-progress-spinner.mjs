...
TDSProgressSpinnerComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSProgressSpinnerComponent, selectors: [["tds-spinner"]], hostAttrs: [1, "block", "relative", "overflow-hiden"], hostVars: 2, hostBindings: function TDSProgressSpinnerComponent_HostBindings(rf, ctx) {
        if (rf & 2) {
            i0.ɵɵclassMap(ctx.cssColor);
        }
    }, inputs: { color: "color" }, features: [i0.ɵɵInheritDefinitionFeature], decls: 2, vars: 0, consts: [["viewBox", "0 0 16 16", "fill", "none", "xmlns", "http://www.w3.org/2000/svg", 1, "animate-spin", "w-full", "h-full"], ["d", "M8 0C9.58225 1.88681e-08 11.129 0.469192 12.4446 1.34824C13.7602 2.22729 14.7855 3.47672 15.391 4.93853C15.9965 6.40034 16.155 8.00887 15.8463 9.56072C15.5376 11.1126 14.7757 12.538 13.6569 13.6569C12.538 14.7757 11.1126 15.5376 9.56072 15.8463C8.00887 16.155 6.40034 15.9965 4.93853 15.391C3.47672 14.7855 2.22729 13.7602 1.34824 12.4446C0.469192 11.129 -3.77363e-08 9.58225 0 8L1.56233 8C1.56233 9.27325 1.93989 10.5179 2.64727 11.5766C3.35465 12.6352 4.36008 13.4604 5.53641 13.9476C6.71274 14.4349 8.00714 14.5624 9.25593 14.314C10.5047 14.0656 11.6518 13.4524 12.5521 12.5521C13.4524 11.6518 14.0656 10.5047 14.314 9.25593C14.5624 8.00714 14.4349 6.71274 13.9476 5.53641C13.4604 4.36008 12.6352 3.35465 11.5766 2.64727C10.5179 1.93989 9.27325 1.56233 8 1.56233L8 0Z", "fill", "currentColor"]], template: function TDSProgressSpinnerComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵnamespaceSVG();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSProgressSpinnerComponent, [{
            type: Component,
            args: [{
...
function TDSSpinComponent_ng_template_0_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSSpinComponent_div_2_div_3_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSSpinComponent_div_2_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSSpinComponent_div_3_Template(rf, ctx) {
    if (rf & 1) {
...
TDSSpinComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSSpinComponent, selectors: [["tds-spin"]], hostVars: 4, hostBindings: function TDSSpinComponent_HostBindings(rf, ctx) {
        if (rf & 2) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSpinComponent, [{
            type: Component,
            args: [{
                    selector: 'tds-spin',
                    exportAs: 'tdsSpin',
  ...
  `,
        ...
        return [{ type: i1.TDSConfigService }, { type: i0.ChangeDetectorRef }, { type: i2.Directionality, decorators: [{
                        type: Optional
                    }] }];
    }, { indicator: [{
                type: Input
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSpinnerModule, [{
            type: NgModule,
            args: [{
                    declarations: [
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSSpinnerModule, { declarations: [TDSProgressSpinnerComponent,
