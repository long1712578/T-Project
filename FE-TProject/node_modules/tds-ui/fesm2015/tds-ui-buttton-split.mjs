...
class TDSButtonSplit extends _TButtonSplitMixinBase {
    ...
    p_UpdateClass() {
        ...
        this.ngClsButton = Object.assign({ "p-1": this.size == 'sm', "p-1.5": this.size == 'md', "p-2": this.size == 'lg' }, color);
        this.ngClsLabel = Object.assign({ "py-1": this.size == 'sm', "px-2.5": this.size == 'sm', "py-1.5": this.size == 'md', "px-3": this.size == 'md' || this.size == 'lg', "py-2": this.size == 'lg' }, color);
    }
    _getHostElement() {
...
TDSButtonSplit.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSButtonSplit, selectors: [["tds-button-split"]], viewQuery: function TDSButtonSplit_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, hostAttrs: [1, "inline-block"], hostVars: 8, hostBindings: function TDSButtonSplit_HostBindings(rf, ctx) {
        if (rf & 2) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSButtonSplit, [{
            type: Component,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSButtonSpitModule, [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSButtonSpitModule, { declarations: [TDSButtonSplit], imports: [CommonModule,
            TDSButtonModule,
