...
const _c0$1 = ["imgRef"];
function TDSImagePreviewComponent_ng_container_8_img_1_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSImagePreviewComponent_ng_container_8_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSImagePreviewComponent_li_10_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSImagePreviewComponent_ng_container_11_Template(rf, ctx) {
    if (rf & 1) {
...
class TDSImagePreviewComponent {
    constructor(cdr, tdsConfigService, config, overlayRef) {
        ...
        this.zoom = (_a = this.config.zoom) !== null && _a !== void 0 ? _a : 1;
        this.rotate = (_b = this.config.rotate) !== null && _b !== void 0 ? _b : 0;
    ...
    get animationDisabled() {
        var _a;
        return (_a = this.config.noAnimation) !== null && _a !== void 0 ? _a : false;
    }
    get maskClosable() {
        var _a, _b;
        const defaultConfig = this.tdsConfigService.getConfigForComponent(TDS_CONFIG_MODULE_NAME$2) || {};
        return (_b = (_a = this.config.maskClosable) !== null && _a !== void 0 ? _a : defaultConfig.maskClosable) !== null && _b !== void 0 ? _b : true;
    }
    setImages(images) {
        this.images = images;
...
TDSImagePreviewComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSImagePreviewComponent, selectors: [["tds-image-preview"]], viewQuery: function TDSImagePreviewComponent_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, hostAttrs: ["tabindex", "-1", "role", "document", 1, "fixed", "inset-0", "overflow-auto", "bg-black", "bg-opacity-40"], hostVars: 8, hostBindings: function TDSImagePreviewComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSImagePreviewComponent, [{
            type: Component,
            args: [{
...
class TDSImageService {
    ...
    display(images, config) {
        const configMerged = Object.assign(Object.assign({}, new TDSImagePreviewOptions()), (config !== null && config !== void 0 ? config : {}));
    ...
    createOverlay(config) {
        ...
        const overLayConfig = new OverlayConfig({
            ...
            disposeOnNavigation: (_b = (_a = config.closeOnNavigation) !== null && _a !== void 0 ? _a : globalConfig.closeOnNavigation) !== null && _b !== void 0 ? _b : true,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSImageService, [{
            type: Injectable
        }], function () {
        return [{ type: i3.Overlay }, { type: i0.Injector }, { type: i1.TDSConfigService }, { type: i3$1.Directionality, decorators: [{
                        type: Optional
                    }] }];
    }, null);
})();
...
TDSImageGroupComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSImageGroupComponent, selectors: [["tds-image-group"]], exportAs: ["tdsImageGroup"], ngContentSelectors: _c0, decls: 1, vars: 0, template: function TDSImageGroupComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵprojectionDef();
            i0.ɵɵprojection(0);
        }
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSImageGroupComponent, [{
            type: Component,
            args: [{
...
TDSImageDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: TDSImageDirective, selectors: [["img", "tds-image", ""]], hostBindings: function TDSImageDirective_HostBindings(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSImageDirective, [{
            type: Directive,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSImageModule, [{
            type: NgModule,
            args: [{
