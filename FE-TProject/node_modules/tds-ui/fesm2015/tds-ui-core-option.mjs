...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(_TDSOptgroupBase, [{
            type: Directive
        }], function () {
...
TDSOptgroup.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSOptgroup, selectors: [["tds-optgroup"]], hostAttrs: [1, "tds-optgroup"], hostVars: 5, hostBindings: function TDSOptgroup_HostBindings(rf, ctx) {
        if (rf & 2) {
    ...
    }, inputs: { disabled: "disabled" }, exportAs: ["tdsOptgroup"], features: [i0.ɵɵProvidersFeature([{ provide: TDS_OPTGROUP, useExisting: TDSOptgroup }]), i0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c1, decls: 4, vars: 2, consts: [["aria-hidden", "true", 1, "tds-optgroup-label", 3, "id"]], template: function TDSOptgroup_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSOptgroup, [{
            type: Component,
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function TDSOption_tds_pseudo_checkbox_0_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSOption_span_3_Template(rf, ctx) {
    if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(_TDSOptionBase, [{
            type: Directive
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSOption, [{
            type: Component,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSOptionModule, [{
            type: NgModule,
            args: [{
