...
import { InjectionToken, Directive, Inject, Component, ChangeDetectionStrategy, ViewEncapsulation, Optional, Input, HostListener, QueryList, EventEmitter, TemplateRef, ContentChildren, ViewChild, ContentChild, Output, Self, NgModule } from '@angular/core';
 ...
 * @docs-private
 */
const fadeInItems = TDSbuttonMenuAnimations.fadeInItems;
/**
 * @deprecated
 * @breaking-change 8.0.0
 * @docs-private
 */
const transformMenu = TDSbuttonMenuAnimations.transformMenu;
 ...
 */
const TDSBUTTON_MENU_CONTENT = new InjectionToken('TDSButtonMenuContent');
/**
 * Menu content that will be rendered lazily once the menu is opened.
 */
class TDSButtonMenuContent {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSButtonMenuContent, [{
            type: Directive,
            args: [{
 ...
 * @docs-private
 */
function throwTDSMenuMissingError() {
 ...
 * @docs-private
 */
function throwTDSButtonMenuInvalidPositionX() {
 ...
 * @docs-private
 */
function throwTDSMenuInvalidPositionY() {
 ...
 * @docs-private
 */
function throwTDSMenuRecursiveError() {
 ...
 * @docs-private
 */
const TDSBUTTON_MENU_PANEL = new InjectionToken('TDSBUTTON_MENU_PANEL');

const _c0$1 = ["tds-button-menu-item", ""];
const _c1 = ["*"];
 ...
 */
class TDSButtonMenuItem extends _TDSButtonMenuItemMixinBase {
...
TDSButtonMenuItem.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSButtonMenuItem, selectors: [["", "tds-button-menu-item", ""]], hostAttrs: [1, "flex", "flex-col", "justify-center", "w-full", "text-body-2", "font-regular", "hover:bg-neutral-3-50", "focus:outline-none", "px-3", "dark:hover:bg-d-neutral-3-300"], hostVars: 18, hostBindings: function TDSButtonMenuItem_HostBindings(rf, ctx) {
        if (rf & 1) {
    ...
    }, inputs: { disabled: "disabled", disableRipple: "disableRipple", size: "size", role: "role" }, exportAs: ["TDSButtonMenuItem"], features: [i0.ɵɵInheritDefinitionFeature, i0.ɵɵNgOnChangesFeature], attrs: _c0$1, ngContentSelectors: _c1, decls: 1, vars: 0, template: function TDSButtonMenuItem_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵprojectionDef();
            i0.ɵɵprojection(0);
        }
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSButtonMenuItem, [{
            type: Component,
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function TDSButtonMenu_ng_template_0_Template(rf, ctx) {
    if (rf & 1) {
...
const TDSBUTTON_MENU_DEFAULT_OPTIONS = new InjectionToken('tbutton-menu-default-options', {
    providedIn: 'root',
    factory: TDSBUTTON_MENU_DEFAULT_OPTIONS_FACTORY
});
/** @docs-private */
function TDSBUTTON_MENU_DEFAULT_OPTIONS_FACTORY() {
    return {
...
_TDSButtonMenuBase.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: _TDSButtonMenuBase, contentQueries: function _TDSButtonMenuBase_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
    ...
    }, viewQuery: function _TDSButtonMenuBase_Query(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(_TDSButtonMenuBase, [{
            type: Directive
        }], function () {
...
class TDSButtonMenu extends _TDSButtonMenuBase {
...
TDSButtonMenu.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSButtonMenu, selectors: [["tbutton-menu"]], hostVars: 3, hostBindings: function TDSButtonMenu_HostBindings(rf, ctx) {
        if (rf & 2) {
...
const TDSBUTTON_MENU_SCROLL_STRATEGY = new InjectionToken('tbutton-menu-scroll-strategy');
/** @docs-private */
function TBUTTON_MENU_SCROLL_STRATEGY_FACTORY(overlay) {
    return () => overlay.scrollStrategies.reposition();
}
/** @docs-private */
const TDSBUTTON_MENU_SCROLL_STRATEGY_FACTORY_PROVIDER = {
...
TDSButtonMenuTrigger.ɵfac = function TDSButtonMenuTrigger_Factory(t) { return new (t || TDSButtonMenuTrigger)(i0.ɵɵdirectiveInject(i1$2.Overlay), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.ViewContainerRef), i0.ɵɵdirectiveInject(TDSBUTTON_MENU_SCROLL_STRATEGY), i0.ɵɵdirectiveInject(TDSBUTTON_MENU_PANEL, 8), i0.ɵɵdirectiveInject(TDSButtonMenuItem, 10), i0.ɵɵdirectiveInject(i3.Directionality, 8), i0.ɵɵdirectiveInject(i1.FocusMonitor)); };
TDSButtonMenuTrigger.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: TDSButtonMenuTrigger, selectors: [["", "tdsbutton-menu-trigger-for", ""], ["", "tdsbuttonMenuTriggerFor", ""]], hostAttrs: ["aria-haspopup", "true", 1, "tbutton-menu-trigger"], hostVars: 2, hostBindings: function TDSButtonMenuTrigger_HostBindings(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSButtonMenuTrigger, [{
            type: Directive,
            args: [{
        ...
        return [{ type: i1$2.Overlay }, { type: i0.ElementRef }, { type: i0.ViewContainerRef }, { type: undefined, decorators: [{
                        type: Inject,
                        ...
                        type: Optional
                    }] }, { type: TDSButtonMenuItem, decorators: [{
                        type: Optional
                    }, {
                        type: Self
 ...
 */
class _TDSButtonMenuDirectivesModule {
}
_TDSButtonMenuDirectivesModule.ɵfac = function _TDSButtonMenuDirectivesModule_Factory(t) { return new (t || _TDSButtonMenuDirectivesModule)(); };
_TDSButtonMenuDirectivesModule.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: _TDSButtonMenuDirectivesModule });
_TDSButtonMenuDirectivesModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ providers: [TDSBUTTON_MENU_SCROLL_STRATEGY_FACTORY_PROVIDER] });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(_TDSButtonMenuDirectivesModule, [{
            type: NgModule,
            args: [{
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(_TDSButtonMenuDirectivesModule, { declarations: [TDSButtonMenuTrigger,
            TDSButtonMenuContent], exports: [TDSButtonMenuTrigger, TDSButtonMenuContent] });
})();
class TDSButtonMenuModule {
}
TDSButtonMenuModule.ɵfac = function TDSButtonMenuModule_Factory(t) { return new (t || TDSButtonMenuModule)(); };
TDSButtonMenuModule.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: TDSButtonMenuModule });
TDSButtonMenuModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ providers: [TDSBUTTON_MENU_SCROLL_STRATEGY_FACTORY_PROVIDER], imports: [[
            CommonModule,
            OverlayModule,
            _TDSButtonMenuDirectivesModule,
        ], CdkScrollableModule, _TDSButtonMenuDirectivesModule] });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSButtonMenuModule, [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSButtonMenuModule, { declarations: [TDSButtonMenu, TDSButtonMenuItem], imports: [CommonModule,
            OverlayModule, _TDSButtonMenuDirectivesModule], exports: [CdkScrollableModule, TDSButtonMenu, TDSButtonMenuItem, _TDSButtonMenuDirectivesModule] });
})();
...
export { TDSBUTTON_MENU_CONTENT, TDSBUTTON_MENU_DEFAULT_OPTIONS, TDSBUTTON_MENU_PANEL, TDSBUTTON_MENU_SCROLL_STRATEGY, TDSButtonMenu, TDSButtonMenuContent, TDSButtonMenuItem, TDSButtonMenuModule, TDSButtonMenuTrigger, TDSbuttonMenuAnimations, _TDSButtonMenuBase, _TDSButtonMenuDirectivesModule, fadeInItems, transformMenu };
//# sourceMappingURL=tds-ui-button-menu.mjs.map
