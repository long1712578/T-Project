...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSHighlightPipe, [{
            type: Pipe,
            args: [{
                    name: 'tdsHighlight',
                    pure: true
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSHighlightModule, [{
            type: NgModule,
            args: [{
