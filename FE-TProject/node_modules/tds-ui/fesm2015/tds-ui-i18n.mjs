...
var vi_VN = {
    locale: 'vi',
    Pagination: {
        items_per_page: 'hàng trên trang',
        jump_to: 'Đến',
    ...
    DatePicker: {
        ...
        timePickerLocale: {
            ...
            rangePlaceholder: ['Thời gian bắt đầu', 'Thời gian kết kết'],
            time: 'Giờ',
        }
    },
    TimePicker: {
...
const TDS_I18N = new InjectionToken('tds-i18n');
...
const TDS_DATE_LOCALE = new InjectionToken('tds-date-locale');

class TDSI18nService {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSI18nService, [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
TDSI18nPipe.ɵfac = function TDSI18nPipe_Factory(t) { return new (t || TDSI18nPipe)(i0.ɵɵdirectiveInject(TDSI18nService, 16)); };
TDSI18nPipe.ɵpipe = /*@__PURE__*/ i0.ɵɵdefinePipe({ name: "tdsI18n", type: TDSI18nPipe, pure: true });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSI18nPipe, [{
            type: Pipe,
            args: [{
                    name: 'tdsI18n'
                }]
        }], function () { return [{ type: TDSI18nService }]; }, null);
})();

class TDSI18nModule {
}
TDSI18nModule.ɵfac = function TDSI18nModule_Factory(t) { return new (t || TDSI18nModule)(); };
TDSI18nModule.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: TDSI18nModule });
TDSI18nModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({});
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSI18nModule, [{
            type: NgModule,
            args: [{
                    declarations: [TDSI18nPipe],
                    exports: [TDSI18nPipe]
                }]
        }], null, null);
})();
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSI18nModule, { declarations: [TDSI18nPipe], exports: [TDSI18nPipe] }); })();

const TDS_DATE_CONFIG = new InjectionToken('date-config');
const TDS_DATE_CONFIG_DEFAULT = {
    firstDayOfWeek: undefined
};
function mergeDateConfig(config) {
    return Object.assign(Object.assign({}, TDS_DATE_CONFIG_DEFAULT), config);
}
...
DateHelperService.ɵfac = function DateHelperService_Factory(t) { return new (t || DateHelperService)(i0.ɵɵinject(TDSI18nService), i0.ɵɵinject(TDS_DATE_CONFIG, 8)); };
DateHelperService.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: DateHelperService, factory: function DateHelperService_Factory(t) {
        let r = null;
        if (t) {
            r = new t();
        }
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DateHelperService, [{
        ...
        return [{ type: TDSI18nService }, { type: undefined, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
...
export { DATE_HELPER_SERVICE_FACTORY, DateHelperByDateFns, DateHelperByDatePipe, DateHelperService, TDSI18nModule, TDSI18nPipe, TDSI18nService, TDS_DATE_CONFIG, TDS_DATE_CONFIG_DEFAULT, TDS_DATE_LOCALE, TDS_I18N, ar_EG, az_AZ, bg_BG, by_BY, ca_ES, cs_CZ, da_DK, de_DE, el_GR, en_GB, en_US, es_ES, et_EE, fa_IR, fi_FI, fr_BE, fr_FR, ga_IE, gl_ES, he_IL, hi_IN, hr_HR, hu_HU, hy_AM, id_ID, is_IS, it_IT, ja_JP, ka_GE, kmr_IQ, kn_IN, ko_KR, ku_IQ, lt_LT, lv_LV, mergeDateConfig, mk_MK, mn_MN, ms_MY, nb_NO, ne_NP, nl_BE, nl_NL, pl_PL, pt_BR, pt_PT, ro_RO, ru_RU, sk_SK, sl_SI, sr_RS, sv_SE, ta_IN, th_TH, tr_TR, uk_UA, vi_VN, zh_CN, zh_HK, zh_TW };
//# sourceMappingURL=tds-ui-i18n.mjs.map
