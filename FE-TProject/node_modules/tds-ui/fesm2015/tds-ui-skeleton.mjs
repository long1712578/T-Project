...
TDSSkeletonElementDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: TDSSkeletonElementDirective, selectors: [["tds-skeleton-element"]], hostVars: 4, hostBindings: function TDSSkeletonElementDirective_HostBindings(rf, ctx) {
        if (rf & 2) {
            i0.ɵɵclassProp("tds-skeleton-active", ctx.tdsActive)("animate-pulse", ctx.tdsActive);
        }
    }, inputs: { tdsActive: "tdsActive", tdsType: "tdsType" } });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSkeletonElementDirective, [{
            type: Directive,
            args: [{
...
TDSSkeletonElementButtonComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSSkeletonElementButtonComponent, selectors: [["tds-skeleton-element", "tdsType", "button"]], inputs: { tdsShape: "tdsShape", tdsSize: "tdsSize" }, features: [i0.ɵɵNgOnChangesFeature], attrs: _c0$1, decls: 1, vars: 15, consts: [[1, "tds-skeleton-button", "inline-block", "bg-neutral-2-100", "dark:bg-d-neutral-2-200", 3, "ngStyle"]], template: function TDSSkeletonElementButtonComponent_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSkeletonElementButtonComponent, [{
            type: Component,
            args: [{
...
TDSSkeletonElementAvatarComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSSkeletonElementAvatarComponent, selectors: [["tds-skeleton-element", "tdsType", "avatar"]], hostAttrs: [1, "inline-block"], inputs: { tdsShape: "tdsShape", tdsSize: "tdsSize" }, features: [i0.ɵɵNgOnChangesFeature], attrs: _c1, decls: 1, vars: 9, consts: [[1, "tds-skeleton-avatar", "rounded-[50%]", "h-[58px]", "w-[58px]", "inline-block", "align-top", "bg-neutral-2-100", "dark:bg-d-neutral-2-200", 3, "ngStyle"]], template: function TDSSkeletonElementAvatarComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵelement(0, "span", 0);
        }
        if (rf & 2) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSkeletonElementAvatarComponent, [{
            type: Component,
            args: [{
                    changeDetection: ChangeDetectionStrategy.OnPush,
...
TDSSkeletonElementInputComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSSkeletonElementInputComponent, selectors: [["tds-skeleton-element", "tdsType", "input"]], hostAttrs: [1, "inline-block"], inputs: { tdsSize: "tdsSize" }, features: [i0.ɵɵNgOnChangesFeature], attrs: _c2, decls: 1, vars: 7, consts: [[1, "tds-skeleton-input", "block", "align-top", "bg-neutral-2-100", "dark:bg-d-neutral-2-200", "w-full", "rounded-md", 3, "ngStyle"]], template: function TDSSkeletonElementInputComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵelement(0, "span", 0);
        }
        if (rf & 2) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSkeletonElementInputComponent, [{
            type: Component,
            args: [{
                    changeDetection: ChangeDetectionStrategy.OnPush,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSkeletonElementImageComponent, [{
            type: Component,
            args: [{
                    changeDetection: ChangeDetectionStrategy.OnPush,
...
function TDSSkeletonComponent_ng_container_0_div_1_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSSkeletonComponent_ng_container_0_h3_3_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelement(0, "h3", 7);
    }
    if (rf & 2) {
...
function TDSSkeletonComponent_ng_container_0_ul_4_li_1_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSSkeletonComponent_ng_container_0_ul_4_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSSkeletonComponent_ng_container_0_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSSkeletonComponent_ng_container_1_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
        i0.ɵɵprojection(1);
        i0.ɵɵelementContainerEnd();
...
class TDSSkeletonComponent {
    ...
    getTitleProps() {
        ...
        return Object.assign({ width }, this.getProps(this.tdsTitle));
    }
    getAvatarProps() {
        const shape = !!this.tdsTitle && !this.tdsParagraph ? 'square' : 'circle';
        const size = 'md';
        return Object.assign({ shape, size }, this.getProps(this.tdsAvatar));
    }
    getParagraphProps() {
        const hasAvatar = !!this.tdsAvatar;
        ...
        return Object.assign(Object.assign({}, basicProps), this.getProps(this.tdsParagraph));
    }
    getProps(prop) {
...
TDSSkeletonComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSSkeletonComponent, selectors: [["tds-skeleton"]], hostAttrs: [1, "table", "w-full", "box-border"], hostVars: 8, hostBindings: function TDSSkeletonComponent_HostBindings(rf, ctx) {
        if (rf & 2) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSkeletonComponent, [{
            type: Component,
            args: [{
                    changeDetection: ChangeDetectionStrategy.OnPush,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSkeletonModule, [{
            type: NgModule,
            args: [{
                    declarations: [
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSSkeletonModule, { declarations: [TDSSkeletonComponent,
            TDSSkeletonElementDirective,
            TDSSkeletonElementButtonComponent,
            TDSSkeletonElementAvatarComponent,
            TDSSkeletonElementImageComponent,
