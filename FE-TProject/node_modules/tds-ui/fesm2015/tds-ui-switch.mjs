...
function TDSSwitch_ng_container_0_Template(rf, ctx) {
    if (rf & 1) {
...
function TDSSwitch_ng_template_1_Template(rf, ctx) {
    if (rf & 1) {
...
TDSSwitch.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TDSSwitch, selectors: [["tds-switch"]], viewQuery: function TDSSwitch_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, hostAttrs: [1, "inline-block"], hostVars: 1, hostBindings: function TDSSwitch_HostBindings(rf, ctx) {
        if (rf & 2) {
            i0.ɵɵhostProperty("id", ctx.id);
        }
    }, inputs: { size: "size", checked: "checked", disabled: "disabled" }, outputs: { change: "change" }, exportAs: ["tdsSwitch"], features: [i0.ɵɵProvidersFeature([TDS_SWITCH_VALUE_ACCESSOR]), i0.ɵɵInheritDefinitionFeature], decls: 3, vars: 2, consts: [[4, "ngIf", "ngIfElse"], ["switchDisable", ""], [1, "cursor-pointer"], ["label", ""], [1, "border", "focus:outline-none", "switch", "py-0.5", "rounded-full", "block", "focus:border-primary-1", "focus:ring-3", "focus:ring-primary-1", "focus:ring-opacity-20", 3, "ngClass", "tabindex"], ["type", "checkbox", 1, "hidden", 3, "checked", "disabled", "change", "click"], ["input", ""], [1, "rounded-full", "block", 3, "ngClass"], [1, "cursor-not-allowed"], [1, "border", "focus:outline-none", "switch", "py-0.5", "rounded-full", "block", "border-neutral-2-200", "dark:border-d-neutral-2-200", 3, "ngClass", "tabindex"]], template: function TDSSwitch_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSwitch, [{
            type: Component,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TDSSwitchModule, [{
            type: NgModule,
            args: [{
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TDSSwitchModule, { declarations: [TDSSwitch], imports: [ReactiveFormsModule,
            FormsModule,
